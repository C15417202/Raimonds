#
# This Python Code, Recieve/Send CAN Bus Messages and
...
def ButtonHandler():
    # Pack the Can bus message and send to radio
    print("Got a button press")
    bus = can.interface.Bus(channel='can0', bustype='socketcan_native')
    msg = can.Message(arbitration_id = 0x13, is_fd = 0, data=[0x34,0x12])
    bus.send(msg)
